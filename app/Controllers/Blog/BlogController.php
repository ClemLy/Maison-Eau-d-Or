					...
					<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"border: 1px solid #ccc; background-color: #fff; padding: 20px;\">
					  ...
					  <tr>
						<td align=\"center\" style=\" padding: 20px;\">
							...
							<p style=\"color: #333; font-size: 11px; line-height: 1.5; text-align: left; margin-top: 50px;\"> Pour vous désinscrire des newletters et ne plus recevoir de mail publicitaire, connectez-vous <a href=\"".site_url('/account/update')."\">  </a> ici puis décochez l'inscription aux newletters.</p>
						</td>
					  </tr>
					  <!-- Footer -->
					  <tr>
